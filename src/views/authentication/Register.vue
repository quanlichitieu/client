...
export default {
    ...
    methods: {
        ...
        submitForm(e) {
            ...
            //form validation
            if (nameValidation(this.form.name)) {
                this.error = nameValidation(this.form.name);
                return;
            }
            ...
            if (passwordValidation(this.form.password2)) {
                this.error = passwordValidation(this.form.password2);
                return;
            }
